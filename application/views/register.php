...
<div class="login-page">
  <div class="form">
  <h1 id="form_heading">Register</h1>
    <?php echo form_open(base_url().'register/register_user'); ?>
    
      <input type="text" name="register_username" value="<?=set_value('register_username')?>" placeholder="Username"/>
      <?php echo form_error('register_username'); ?>
      
	    <input type="text" name="register_email" value="<?=set_value('register_email')?>" placeholder="Email address"/>
